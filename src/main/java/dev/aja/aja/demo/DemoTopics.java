...
public class DemoTopics {
        ...
        /**
         * Ejemplos de TopicEntity solicitados a ChatGPT, el prompt fueron varios.
         * 
         * @param forumList       lista de Forums para recorrer.
         * @param demoUsers       para obtener los usuarios de ejemplos
         * @param forumRepository repositorio para salvar cada ForumEntity editado
         *                        añadiendo un TopicEntity
         */
